...
export default function StressReliefScreen() {
  ...
  const textHighlight = useRef(new Animated.Value(0)).current;
  ...
  const generateCalmingScript = async () => {
    try {
        ...
        messages: [
          {
            role: "system",
            content:
              "You are a calming meditation guide focused on stress relief. Keep responses concise, warm, and encouraging.",
          },
          {
            role: "user",
            content:
              "Create a short calming script (1 paragraphs) that helps relieve stress and anxiety, and ends by encouraging the user to try the 4-7-8 breathing technique. Make it personal and compassionate.",
          },
        ],
      ...
      const fallbackScript =
        "Take a moment to center yourself. Focus on your breath and let's begin this journey to relaxation together.";
