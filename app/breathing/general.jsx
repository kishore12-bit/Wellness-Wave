...
export default function GeneralRelaxationScreen() {
  ...
  const generateCalmingScript = async () => {
    try {
        ...
        messages: [
          {
            role: "system",
            content:
              "You are a calming meditation guide focused on general relaxation. Keep responses concise, warm, and encouraging.",
          },
          {
            role: "user",
            content:
              "Create a short calming script (1 paragraph) that helps achieve general relaxation, and ends by encouraging the user to try the 5-2-5 breathing technique. Make it personal and compassionate.",
          },
        ],
      ...
      const fallbackScript =
        "Welcome to a moment of peaceful relaxation. Let's take this time to find balance and tranquility together.";
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="General Relaxation" />
      ...
      {!showBreathing ? (
        ...
        <View style={styles.content}>
          ...
          <Instructions
            title="5-2-5 Relaxation Breathing"
            instructions={
